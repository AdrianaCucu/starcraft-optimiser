...
public class Decision {
    ...
    public static void updateState(int index) {
        switch (index) {
            ...
            // "build hellion"
            case 0: {
                if (Hellion.score == Goal.maxScore && GameState.minerals >= 100 && GameState.freeBuildings.get(Factory.IDENT) > 0) {
            ...
            // "build marine"
            case 1: {
                if (Marine.score == Goal.maxScore && GameState.minerals >= 50 && GameState.freeBuildings.get(Barracks.IDENT) > 0) {
            ...
            // "build medivac"
            case 2: {
                if (Medivac.score == Goal.maxScore && GameState.minerals >= 100 && GameState.gas >= 100 && GameState.freeBuildings.get(Starport.IDENT) > 0) {
            ...
            // "build viking"
            case 3: {
                if (Viking.score == Goal.maxScore && GameState.minerals >= 150 && GameState.gas >= 75 && GameState.freeBuildings.get(Starport.IDENT) > 0) {
            ...
            // "build worker"
            case 4: {
                if (Worker.score == Goal.maxScore && GameState.minerals >= 50 && GameState.freeBuildings.get(CommandCenter.IDENT) > 0
            ...
            // "build supply depot"
            case 5: {
                if (SupplyDepot.score == Goal.maxScore && GameState.minerals >= 100
                    && GameState.freeBuildings.get(SupplyDepot.IDENT) + GameState.busyBuildings.get(SupplyDepot.IDENT) < 3) {
            ...
            // "build barracks"
            case 6: {
                if (Barracks.score == Goal.maxScore && GameState.minerals >= 150
                        && (GameState.freeBuildings.get(SupplyDepot.IDENT) > 0 || GameState.busyBuildings.get(SupplyDepot.IDENT) > 0)
                        && GameState.freeBuildings.get(Barracks.IDENT) + GameState.busyBuildings.get(Barracks.IDENT) < 3) {
            ...
            case 7: {
                if (CommandCenter.score == Goal.maxScore && GameState.minerals >= 400) {
            ...
            // "build refinery"
            case 8: {
                if (Refinery.score == Goal.maxScore && GameState.minerals >= 75
            ...
            // "build factory"
            case 9: {
                if (Factory.score == Goal.maxScore && GameState.minerals >= 150 && GameState.gas >= 100
            ...
            // "build starport"
            case 10: {
                if (Starport.score == Goal.maxScore && GameState.minerals >= 150 && GameState.gas >= 100
    ...
    private static void updateState(int index) {
        ...
        switch (index) {
            ...
            // "build barracks"
            case 9: {
                if (Barracks.score == Goal.maxScore && GameState.minerals >= 150 && (GameState.freeBuildings.get(SupplyDepot.IDENT) > 0 || GameState.busyBuildings.get(SupplyDepot.IDENT) > 0)) {
                    ArrayList<Integer> durations = GameState.constructionsBeingBuilt.get(Barracks.IDENT);
                    durations.add(Barracks.buildTime);
                    GameState.constructionsBeingBuilt.put(Barracks.IDENT, durations);
                    GameState.gas -= Barracks.gasCost;
